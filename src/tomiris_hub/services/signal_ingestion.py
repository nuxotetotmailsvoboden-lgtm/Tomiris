            ...
            async with session.begin():
                ...
                session.add(
                    Signal(
                        ...
                        role_version=envelope.role_version,
                        config_version=envelope.config_version,
                        feature_pipeline_version=envelope.feature_pipeline_version,
                        analysis_schema_version=envelope.analysis_schema_version,
                        data_provider=envelope.data_provider,
                        data_as_of=envelope.data_as_of,
                        confidence_model_version=envelope.confidence_model_version,
